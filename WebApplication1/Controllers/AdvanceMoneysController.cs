...
namespace WebApplication1.Controllers
{
    public class AdvanceMoneysController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PayId,DeveloperId,PaymentDate,UserID")] AdvanceMoney advanceMoney)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PayId,DeveloperId,PaymentDate,UserID")] AdvanceMoney advanceMoney)
        {
            if (ModelState.IsValid)
            {
